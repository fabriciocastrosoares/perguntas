...
export default function BonusRodapeF({cards, contConcluidos, imagensRodape}){
    return(
        <QuantidadeAcertos>
            <Parabens><img src = {sad}/><h2>Putz...</h2></Parabens>
            <TextoBaixo><h3>Ainda faltam alguns... Mas não desanime!</h3></TextoBaixo>
